  ...
  return (
    <OnBoardingWrapper>
      <OnBoardingInnerWrapper align="start">
        ...
        <div className="relative z-10 aspect-auto h-[100px] w-[100px] rounded-full border-4 border-main-color">
          <Image
            src={
              selectedMedia ||
        ...
        <Input
          ...
          className="h-[80px] w-[90%] border-none bg-gray-200"
