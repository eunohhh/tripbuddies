...
export default function SearchPageContainer({
  ...
  }, [selectedTripPreferTheme, setSelectedThemes]);

  useEffect(() => {
    setSelectedThemes(selectedBuddyPreferTheme, "SET_BUDDY_THEMES");
  }, [selectedBuddyPreferTheme, setSelectedThemes]);
  ...
  return (
    <div className="bg-white p-5 xl:p-0 xl:py-5">
      <SearchBars
      ...
      <button
        type="button"
        id="result-section"
        className="mx-auto mb-5 flex h-12 w-full items-center justify-center whitespace-nowrap rounded-2xl bg-main-color px-28 font-semibold text-white text-xl transition-colors duration-200 ease-in-out active:bg-gray-300 xl:mb-10 xl:max-w-[348px]"
        onClick={() => {
          setShowResult(true);
          handleShowResult();
        }}
